...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "agreementAnd": MessageLookupByLibrary.simpleMessage(" и "),
        "agreementPrivacyPolicy":
            MessageLookupByLibrary.simpleMessage("Политики конфиденциальности"),
        "agreementStart": MessageLookupByLibrary.simpleMessage(
            "Нажимая на кнопку на этом экране, Вы соглашаетесь с условиями "),
        "agreementUserTerms": MessageLookupByLibrary.simpleMessage(
        ...
        "serverError": MessageLookupByLibrary.simpleMessage(
            "Произошла серверная ошибка, мы уже работаем над её устранением"),
        "somethingWentWrong":
